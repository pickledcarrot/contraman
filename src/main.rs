...
struct Cli {
    ...
    /// Shorthand for `contraman get <name>`
    name: Option<String>,
}
...
fn run() -> Result<(), String> {
    ...
    match (cli.command, cli.name) {
        ...
        (None, None) => {
            println!("Usage:");
            println!("  contraman set <name>");
            println!("  contraman get <name>");
            println!("  contraman <name>");
            println!("  contraman list");
            println!("  contraman remove <name>");
            Ok(())
        }
